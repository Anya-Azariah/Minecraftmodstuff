package net.anya.tutorialmod.entity.custom;

import net.anya.tutorialmod.entity.ModEntities;
import net.anya.tutorialmod.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    private void setUpAnimationStates(){
        ...
        if (this.isAttacking() && attackAnimationTimeout <= 0 ){
           attackAnimationTimeout = 80; //length in ticks is time of animation
